...
- **No endorsements are required to publish.** Zero-endorsement content is fully accessible and flagged as "not yet endorsed," sorting below endorsed content by default (Section 9.3) but never hidden.
